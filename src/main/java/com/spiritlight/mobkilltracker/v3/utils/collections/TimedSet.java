...
// The only difference is that the map implementation is now thread unsafe
public class TimedSet<E> extends AbstractSet<E> {

    private final long delay;
    private final TimeUnit unit;

    private final Map<E, ObjectDescriptor<E>> map = new HashMap<>();
    ...
    public TimedSet(long delay, TimeUnit unit) {
        this.delay = delay;
        this.unit = unit;
    }
